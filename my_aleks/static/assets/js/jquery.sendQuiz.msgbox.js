(function () {
    $.SendQuiz = {
        Confirm: function (title,questionInfo,callback,callback2) {
    ...
    var btnAdd = function(callback){
        $('#mb_btn_look').click(function () {
            callback()
        })
    }
  //  var btnLook = function (url) {
  //      $('#mb_btn_look').click(function () {
  //          window.location.href=url+"/abc/teacher/my-quizes/";
  //      })
  //  }
})();
